...
# Single NAT gateway (cost-conscious). For zero egress + lower attack surface,
# replace with VPC interface endpoints (ECR, SSM, logs) + S3 gateway endpoint.
...
# VPC flow logs (OWASP A09 - logging & monitoring)
